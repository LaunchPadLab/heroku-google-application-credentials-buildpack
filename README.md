...
1. Create Config Vars key `GOOGLE_CREDENTIALS` and paste the content of service account credential JSON file in a base64 encoded format.
...
```
heroku buildpacks:set https://github.com/LaunchPadLab/heroku-google-application-credentials-buildpack.git -a your-app-name
```
